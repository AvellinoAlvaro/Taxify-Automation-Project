class transactionsPage{
    ...
    elements={
       ...
       calendarFromInput : () => cy.get('[data-reactid=".0.1.0.0.2.1.1.0"] > .input-calendar > .input-calendar__input'),
       calendarToInput : () => cy.get('[data-reactid=".0.1.0.0.2.1.1.1"] > .input-calendar > .input-calendar__input'),
       editStatusButton: () => cy.get('[data-reactid=".0.1.0.0.2.3.0.0.0.0"] > span'),
       ...
       confirmButton: () => cy.get('[data-reactid=".3.1.0.0.1.1.1.1.0"]'),
        allOrdersSelectButton: () => cy.get('.search-results-header > .checkbox-container > input'),
