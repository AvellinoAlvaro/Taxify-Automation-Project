class reportSettingsPage{
    ...
    elements={
        ...
        reportEditBtn: (reportID) => cy.get(`[data-reportid="${reportID}"] > :nth-child(5)`),
        ...
        createReportBtn : () =>  cy.contains('Create reports for a specific date range'),
        ...
        periodSelector : (periodName) => cy.get(`[data-timevalue="${periodName}"]`).first(), 
