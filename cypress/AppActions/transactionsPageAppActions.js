...
class transactionsPageAppActions{
    ...
    deleteOrders = (dateFrom, dateTo, state) =>{
        ...
        transactionsPage.elements.noOrdersText().should('contain','No Matching Transactions');
    ...
    hideOrders = (dateFrom, dateTo, state) =>{
        ...
        transactionsPage.elements.confirmButton().click();
        transactionsPage.elements.statusUpdateText.should('contain','Status update complete!')
