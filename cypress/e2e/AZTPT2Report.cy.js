...
beforeEach(() => {
  ...
  describe('Arizona TPT-2 Privilege Tax Report Imports and Report visualization Testing', () =>{
    ...
    it('Test all Item Types with Tax Type Resale on Monthly Frequency',() =>{
      ...
      simpleImportPageAppActions.simpleImport('AZ_AllItemTypesResale_Oct.xls', '28');
      filingsAutoFilePageAppActions.visualizeReport('Arizona TPT-2 Privilege Tax Report', '10', '2024');
      ...
      transactionsPageAppActions.deleteOrders('10/10/2024','10/10/2024','Arizona');
    ...
    it('Test all the old item types on Monthly Frequency',() =>{
      ...
      simpleImportPageAppActions.simpleImport('AZ_RetailOldItemTypes_Oct.xls', '11');
      filingsAutoFilePageAppActions.visualizeReport('Arizona TPT-2 Privilege Tax Report', '10', '2024');
    ...
    it('Test all the new Item Types introduced with the new changes on Monthly Frequency',() =>{
      ...
      simpleImportPageAppActions.simpleImport('AZ_RetailNewItemTypes_Oct.xls', '17');
      filingsAutoFilePageAppActions.visualizeReport('Arizona TPT-2 Privilege Tax Report', '10', '2024');
