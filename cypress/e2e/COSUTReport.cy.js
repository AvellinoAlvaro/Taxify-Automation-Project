...
beforeEach(() => {
  ...
  describe('CO SUT Reports Generation', () =>{
    ...
    it('Generate Monthly (Sales Tax - PDF) frequency',() =>{
      ...
      reportSettingsPageAppActions.createReport('323','Monthly (Sales Tax (PDF))','2024.10.01')
    ...
    it('Generate Monthly (Sales Tax - XML) frequency',() =>{
      ...
      reportSettingsPageAppActions.createReport('323','Monthly (Sales Tax (XML))','2024.10.01')
    ...
    it('Generate Monthly (Economic Nexus - PDF) frequency',() =>{
      ...
      reportSettingsPageAppActions.createReport('323','Monthly (Economic Nexus (PDF))','2024.10.01')
    ...
    it('Generate Monthly (Economic Nexus - XML) frequency',() =>{
      ...
      reportSettingsPageAppActions.createReport('323','Monthly (Economic Nexus (XML))','2024.10.01')
    ...
    it('Generate Monthly (Use Tax - State Tax Only) frequency',() =>{
      ...
      reportSettingsPageAppActions.createReport('323','Monthly (Use Tax - State Tax Only)','2024.10.01')
    ...
    it('Generate Monthly (Use Tax Only) frequency',() =>{
      ...
      reportSettingsPageAppActions.createReport('323','Monthly (Use Tax Only)','2024.10.01')
    ...
    //Annually Frequencies Reports Generation for year 2024
      ...
      reportSettingsPageAppActions.createReport('323','Annually (Sales Tax (PDF))','2024.01.01')
    ...
    it('Generate Annually (Sales Tax - XML) frequency',() =>{
      ...
      reportSettingsPageAppActions.createReport('323','Annually (Sales Tax (XML))','2024.01.01')
    ...
    it('Generate Annually (Economic Nexus - PDF) frequency',() =>{
      ...
      reportSettingsPageAppActions.createReport('323','Annually (Economic Nexus (PDF))','2024.01.01')
    ...
    it('Generate Annually (Economic Nexus - XML) frequency',() =>{
      ...
      reportSettingsPageAppActions.createReport('323','Annually (Economic Nexus (XML))','2024.01.01')
    ...
    it('Generate Annually (Use Tax - State Tax Only) frequency',() =>{
      ...
      reportSettingsPageAppActions.createReport('323','Annually (Use Tax - State Tax Only)','2024.01.01')
    ...
    it('Generate Annually (Use Tax Only) frequency',() =>{
      ...
      reportSettingsPageAppActions.createReport('323','Annually (Use Tax Only)','2024.01.01')
    ...
    it('Generate Quarterly (Sales Tax - PDF) frequency',() =>{
      ...
      reportSettingsPageAppActions.createReport('323','Quarterly (Sales Tax (PDF))','2024.10.01')
    ...
    it('Generate Quarterly (Sales Tax - XML) frequency',() =>{
      ...
      reportSettingsPageAppActions.createReport('323','Quarterly (Sales Tax (XML))','2024.10.01')
    ...
    it('Generate Quarterly (Economic Nexus - PDF) frequency',() =>{
      ...
      reportSettingsPageAppActions.createReport('323','Quarterly (Economic Nexus (PDF))','2024.10.01')
    ...
    it('Generate Quarterly (Economic Nexus - XML) frequency',() =>{
      ...
      reportSettingsPageAppActions.createReport('323','Quarterly (Economic Nexus (XML))','2024.10.01')
    ...
    it('Generate Quarterly (Use Tax - State Tax Only) frequency',() =>{
      ...
      reportSettingsPageAppActions.createReport('323','Quarterly (Use Tax - State Tax Only)','2024.10.01')
    ...
    it('Generate Quarterly (Use Tax Only) frequency',() =>{
      ...
      reportSettingsPageAppActions.createReport('323','Quarterly (Use Tax Only)','2024.10.01')
  ...
  describe('CO SUT Imports and Report visualization Testing', () =>{
    ...
    it('Test all Item Types with Tax Type Resale on Monthly Frequency',() =>{
      ...
      simpleImportPageAppActions.simpleImport('CO_AllItemTypesResale_Oct.xls', '28');
      filingsAutoFilePageAppActions.visualizeReport('Colorado Retail Sales and Use Tax Return', '10', '2024');
      filingsAutoFilePage.elements.ordersQuantity().should('contain', '28 orders');
      ...
      transactionsPageAppActions.deleteOrders('10/10/2024','10/10/2024','Colorado');
    ...
    it('Test all the old item types on Monthly Frequency',() =>{
      ...
      simpleImportPageAppActions.simpleImport('CO_RetailOldItemTypes_Oct.xls', '11');
      filingsAutoFilePageAppActions.visualizeReport('Colorado Retail Sales and Use Tax Return', '10', '2024');
      filingsAutoFilePage.elements.ordersQuantity().should('contain', '11 orders');
    ...
    it('Test all the new Item Types introduced with the new changes on Monthly Frequency',() =>{
      ...
      simpleImportPageAppActions.simpleImport('CO_RetailNewItemTypes_Oct.xls', '17');
      filingsAutoFilePageAppActions.visualizeReport('Colorado Retail Sales and Use Tax Return', '10', '2024');
      filingsAutoFilePage.elements.ordersQuantity().should('contain', '17 orders');
