...
beforeEach(() => {
  ...
  describe('Arizona TPT2 Reports Generation', () =>{
    ...
    it('Generate Monthly (Express Data Entry) frequency',() =>{
      ...
      reportSettingsPageAppActions.createReport('130','Monthly (Express Data Entry)','2024.10.01')
    ...
    it('Generate Monthly (Free File) frequency',() =>{
      ...
      reportSettingsPageAppActions.createReport('130','Monthly (Free File)','2024.10.01')
     ...
     it('Generate Semi-Annually (Express Data Entry) frequency',() =>{
      ...
      reportSettingsPageAppActions.createReport('130','Semi-Annually (Express Data Entry)','2024.07.01')
    ...
    it('Generate Semi-Annually (Free File) frequency',() =>{
      ...
      reportSettingsPageAppActions.createReport('130','Semi-Annually (Free File)','2024.07.01')
  ...
  describe('OH FULL UST-1 Imports and Report visualization Testing', () =>{
    ...
    it('Test all the old item types on Monthly Express Data Entry Frequency',() =>{
      ...
      simpleImportPageAppActions.simpleImport('OH_RetailOldItemTypes_Oct.xls', '11');
      filingsAutoFilePageAppActions.visualizeReport('Ohio Full UST-1 Data File Upload (Express Data Entry)', '10', '2024');
    ...
    it('Test all the new Item Types introduced with the new changes on Monthly Frequency',() =>{
      ...
      simpleImportPageAppActions.simpleImport('OH_RetailNewItemTypes_Oct.xls', '17');
      filingsAutoFilePageAppActions.visualizeReport('Ohio Full UST-1 Data File Upload (Express Data Entry)', '10', '2024');
