...
describe('Testing Basic Functionalities', () =>{
    ...
    it('Testing Simple Import',() =>{
        ...
        simpleImportPageAppActions.simpleImport('AL_Taxable_ChangeCities_Oct24.xls', '7'); 
    ...
    it('Testing Order Deletion',() =>{
        ...
        Cypress.on('uncaught:exception', (err, runnable) => {
           ...
           transactionsPageAppActions.deleteOrders('10/10/2024','10/10/2024','Alabama');
    ...
    it('Testing Report Creation',() =>{
        ...
        Cypress.on('uncaught:exception', (err, runnable) => {
           ...
           reportSettingsPageAppActions.createReport ('323','Monthly (Economic Nexus (PDF))','2024.07.01');
    ...
    it.only('Testing Report Visualization',() =>{
        ...
        filingsAutoFilePageAppActions.visualizeReport('Colorado Retail Sales and Use Tax Return', '9', '2024');
